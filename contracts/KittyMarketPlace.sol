import "./BeaverOwnership.sol";

pragma solidity ^0.5.0;

contract BeaverMarketPlace is BeaverOwnership {
  ...
  {
    /*
    *   We give the contract the ability to transfer beavers
    *   As the beavers will be in the market place we need to be able to transfert them
    *   We are checking if the user is owning the beaver inside the approve function
    */
    ...
    public
  {
    ...
    require(offer.seller == msg.sender, "You should own the beaver to be able to remove this offer");
  ...
  function buyBeaver(uint256 _tokenId)
    public
    payable
  {
    Offer memory offer = tokenIdToOffer[_tokenId];
