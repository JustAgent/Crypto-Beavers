...
Stage 1 is a simple interface to generate random beavers and save them on the cryptobeavers smart contract.
...
it will be nice to introduce this concept which is not in the original cryptobeavers app
